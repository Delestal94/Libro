...
| **H91** | Quinta ronda: la escena de veresh del cap. 3 se vació del todo (sólo enseñaba que las palabras «sonaban distintas», no qué significaban) — un niño no puede *elegir* la correcta en el cap. 6 sin saber qué significa cada una. Además el `avanesh` del cap. 6 tenía tres imprecisiones frente al arco 1 (hora del día, antecedente ambiguo de «esa misma palabra») y un eco de edad con el cap. 5 («A Sel, con nueve años») | verificacion-05-sistema, verificacion-06-estructura (28-08) | 🟢 **cerrado.** Cap. 3 reescrito para que Sel explique el significado real (padre de verdad / el que sólo hace de eso) y Toma lo conecte, sin interés, con Tarin — entiende y le da igual, en vez de no entender o analizarlo de más. Cap. 6: «aquella tarde» → «aquel día»; antecedente de la cita aclarado; «con nueve años» cortado; «Toma no pareció darse cuenta» pasa a abrir su propio párrafo |
| **H92** | Sexta ronda de verificación, ambos críticos: recomiendan parar de iterar por frases — los criterios que quedan piden escenas nuevas, no enmiendas, y el patrón de cada ronda (adelgazar lo último tocado) tiene rendimiento decreciente | verificacion-05, verificacion-06 (28-08) | 🔴 **aceptado, sin más rondas.** Nota final del arco: 5/8 (sistema), 4/8 (estructura) — sube desde 3-3,5/8 iniciales. Documentado como cierre deliberado, no como iteración interrumpida a medias |
...
| **H24** | (arco 2) El capítulo 5 explica el sistema con una tabla de números en vez de vivirlo en escena | 3 lectores (2 adultos, 1 niño de 13) | 🟢 **cerrado en cuatro rondas.** 1ª (11-08): añadidas las lámparas sin quitar la columna de números. 2ª (28-08): quitada la columna, pero quedó un «libro grueso abierto» sin función y un tercer escalón reversible pese a decir «eso no tiene raya de vuelta». 3ª (28-08): el libro se sustituye por un cuenco y un trapo; el tercer ejemplo pasa a ser un padre que pierde para siempre el recuerdo de la cara de su hijo recién nacido. La verificación de esa 3ª ronda encontró que quitar el libro dejó «muebles» huérfanos («la mesa», «otra silla» sin antecedente) y que la repetición «Sel se quedó mirando las tres lámparas» seguía intacta, con dos estados de comprensión contradictorios (línea 48: entiende sin que nadie se lo explique; línea 75: no puede nombrarlo del todo). 4ª ronda (28-08): añadida la mesa a la descripción inicial, «otra silla» → «ninguna silla», la segunda mirada a las lámparas sustituida por una reflexión distinta (los veintidós años de Yeva), y cortada la coda del tercer escalón que parafraseaba peor un hallazgo del cap. 4 |
