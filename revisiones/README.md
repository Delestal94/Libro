...
|---|---|---|---|
| **H22** | El motor del arco 2 —dos Huérfanos, un mes de crisis de creencia en el pueblo— nunca se dramatiza. El cap. 1 muestra el papel fallando por completo; el cap. 6 afirma un mes de conflicto que ningún capítulo intermedio escribió | 4 críticos (estructura, personajes, sistema, mercado) | 🟡 **intentado el 11-08 (escena del pan, cap. 3 + enumeración en cap. 5), verificado y a medias por los dos críticos que lo abrieron.** Se gana algo real: alguien de Adruin elige entre los dos, y Bern pierde algo visible. Sigue faltando una página donde Adruin **conceda** el papel — nadie llama Huérfano a Sel entre el cap. 1 y el 5 — y 3 de los 4 incidentes del cap. 5 son resumen en boca de Bern, no escena. La prueba del tachado en 6.2 da el mismo resultado que antes de tocar nada |
| **H23** | `decisiones.md` § K se aplica al revés dentro del mismo arco: no cobra con resistencia real (cap. 3, trece personas) y cobra un sentido entero sin ninguna persona resistiéndose (cap. 4, una lámpara) | 1 crítico (sistema), con auditoría textual de ambos capítulos | 🟡 **intentado el 11-08** (tabla nueva en § K que distingue el papel sobre personas de la magia doméstica de § F). **Verificación dividida:** un crítico lo da por cerrado para el cap. 4; el otro encuentra que la propia tabla nueva describe el cap. 3 como «dos resistiéndose» cuando el texto real es gente en desacuerdo de método, no resistencia a Sel — contradicción dentro del propio arreglo. Quedan abiertos además R2/R3 (`mundo.md` regla 2 sigue diciendo «todo cuesta»; de dónde sale la competencia de Sel si no hace falta papel) |
...
| **H28** | «Ya lo sé... por eso es peor» (cap. 3, la escena nueva) repite la estructura exacta de la mejor línea del clímax — «Ya lo sé. Es peor. Ha bastado con que dejaras el mío» (cap. 6) | 2 verificadores (estructura y sistema), independientes, sin que se les pidiera buscar esto | 🔴 **daño colateral del intento de cerrar H22** — se gastó la mejor línea del arco preparando el conflicto que debía resolver |
| **H29** | Cronología incompatible dentro de la misma conversación (cap. 5): Bern dice «una semana» y once líneas después «así lleva ya semanas» — mismo hablante, misma tarde. Los hechos internos dan la razón a la primera cifra | 2 verificadores, independientes, sin que se les pidiera buscar esto | 🔴 **daño colateral del intento de cerrar H22** — y hace que «un mes» (cap. 6) encaje todavía peor que antes |

**Leyenda igual que arriba.** H22-H25 son del arco 2 y decisión del usuario, no de un
panel. H28 y H29 son daños nuevos, producidos al intentar cerrar H22 sin pedir permiso —
**no se ha vuelto a tocar nada desde la verificación**: toca que el usuario decida el
siguiente paso. Ver "Lo que esto pide, en orden" en
