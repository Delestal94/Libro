...
> **Dónde está todo al terminar el último capítulo escrito.** Se actualiza al cerrar cada
> capítulo, y es lo que lee un agente que va a escribir una escena **en vez de leerse el
> libro entero**.
>
...
que sepa en qué se mete si se queda.

**Ya vio a Coren de cerca** — el patrocinador principal, dueño de media Yenal. No es cruel:
pregunta por Nea por su nombre, se preocupa de si le duelen las manos, saluda a los niños
que barren la calle. Paga el doble por la flor de color sin nombre, con su nombre en la
placa — no por generosidad, por exclusividad: «Quiero seguir siendo el único.» Nea: «No es
mala persona. Eso es lo peor.»

**Sel le pidió a Osane aprender, esta vez sabiendo ya el precio** — primera vez que toma
un papel informado, no por accidente ni por urgencia ajena. Osane aceptó: empiezan por
...
con Yeva en vez de tomar el atajo: tardará años, no le costará memoria, y al final será
suyo de verdad. Ila aceptó quedarse cuando Sel se ofreció a hacer lo mismo y ella le dijo
que no: *«Tú tienes que llegar a algún sitio. Yo sólo tenía que salir de uno.»* Al
despedirse le dio la primera página que escribió bien, sin decirle qué pone —«para cuando
lo sepas, ya vas a saber leer tú solo»— y le prometió esperar a que Sel tenga algo que
darle a cambio.

**Cabo suelto, a propósito:** la lámpara de Reta sigue encendida sin papel formal detrás,
y ella no sabe bien qué debe ni a quién.

**Sel probó por primera vez el método, no el accidente, con *halumi ish*:** se lo preguntó
a un desconocido sin Ila delante y fracasó distinto — no por la respuesta, sino porque la
pregunta sola, sin un pueblo sosteniéndola detrás, no llega a ningún sitio. Anotó: *«Preguntar
bien es un oficio. Hay que aprenderlo.»*

## Qué lleva encima

**Sel** (9 años) — un gorro que le viene enorme · un cuchillo que le dio Tarin · pan de Anu
· la hoja de las veintiséis frases tachadas, y ahora una línea nueva sobre la pregunta
misma · **la página de Ila, doblada, sin leer**.

## La lista

Lo que Sel se ha gastado, en la página, de su puño:
...
- Que un papel da lo que ese papel sabe hacer, no sólo el trato de los demás — y que hay
  que haberlo visto de cerca para poder tomarlo *([[decisiones]] · M)*
- Que **sólo se lleva uno a la vez**, y lo aprendió soltando el Huérfano
- Que el Huérfano no funciona con quien no lo conoce — un papel es lo que eres a ojos de
  los demás, y en un sitio nuevo nadie te ha visto ser nada todavía
- Que preguntar bien, como pedir, es un oficio que no domina y quiere aprender
- Que las cosas se pagan, y ahora conoce parte del precio: un sentido entero cada vez
- Que hay un armario, a once días de Keliun, con una ficha por niño como él — y que él no
  tiene ficha, y sigue sin saber por qué

## Lo que Sel NO sabe

- Que preguntar *halumi ish* le cuesta algo a quien contesta *([[decisiones]] · G)*
- De qué está hecha la luz del musgo, ni por qué a él no le costó nada encender la primera
  lámpara pequeña y sí la de Reta
- Que Ila lleva un registro de lo que pierde
- Quién es el narrador
- Que el nudo de más en el haranu va a abrir el otro
- Qué pone la página que le dio Ila
...
- Que el narrador estuvo en Adruin también: «Yo también las conté, la primera vez»
  (arco 2, cap. 1)

## Quién queda atrás

**En Keliun:** Anu (panadera, sola otra vez) · Tarin (herrero) · los dos hermanos de Ila,
con su padre, que la odia · el del molino, sin su sueño · Oren, que no se acuerda de nada.

**En Adruin:** Ila (escuela de escritura) · Bern (aprendiz de Yeva) · Yeva (Guardadora
licenciada) · Reta (con una lámpara que no sabe bien qué le costó).
...
Un agente que va a escribir una escena lee **este fichero, [[voz]], las fichas de quien
salga, y las filas de [[pistas]] de su capítulo**. Nada más. Con eso escribe.

Y al terminar el capítulo, **este fichero se actualiza**: la lista, los contadores, lo que
el lector sabe. Si no se actualiza, el siguiente agente escribe a ciegas.
